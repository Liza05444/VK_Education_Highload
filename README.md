...
| **media-service** | 45 834 | 45 834 / 4 000 | 16 | 16 ГБ |
| **inbox-worker** | 250 000 | 250 000 / 5 000 | 50 | 10 ГБ |
| **archive-worker** | 125 000 | 125 000 / 10 000 | 15 | 6 ГБ |
| **notification-service** | 50 000 | 50 000 / 10 000 | 9 | 3 ГБ |
| **Итого** | | | **162** | **123 ГБ** |
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **Kubernetes Cluster** | CyberServe Xeon SP1-102G | Xeon Silver 4514Y / 128GB RAM / 2x1TB NVMe / 10Gbps | 16 | 36 | €5 490 | €197 640 | €3 294 | AX102: €122.30 × 36 = €4 402.80 |
...
| **Итого** | | | | **326** | | **€1 781 960** | **€29 699** | **€72 929.80** |
...
| **notification-service** | 3 | 3 | 1 ГБ | push уведомления |
...
Примечание:
1. Для Kubernetes в DC5 требуется 162 CPU. С учетом 20% накладных расходов Kubernetes: 162 × 1,2 ≈ 195 CPU. Минимум: 195 / 16 ≈ 13 серверов. Для DC5 принято 14 серверов с запасом нагрузки; для остальных ДЦ количество снижено пропорционально доле трафика: 14 + 7 + 7 + 4 + 4 = 36 серверов.
