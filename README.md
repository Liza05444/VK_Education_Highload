...
| **Итого** | | | | **322** | | **€1 760 000** | **€29 333** | **€72 440.60** |
...
Примечание:
1. Для Kubernetes в DC5 требуется 162 CPU. С учетом 20% накладных расходов Kubernetes: 162 × 1,2 ≈ 195 CPU. Минимум: 195 / 16 ≈ 13 серверов. Для DC5 принято 14 серверов с запасом нагрузки; для остальных ДЦ количество снижено пропорционально доле трафика: 14 + 7 + 7 + 2 + 2 = 32 сервера.
