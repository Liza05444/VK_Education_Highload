...
Каждый из 5 основных дата-центров имеет свою собственную базу данных для хранения данных тех пользователей, которые к нему привязаны. При смене региона клиентское приложение способно самостоятельно переключиться на альтернативный регион (так как хранит список IP-адресов всех 5 ДЦ).
