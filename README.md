...
* **Групповые чаты и каналы:** привязываются к одному конкретному ДЦ («родной» ДЦ создателя) для обеспечения строгой последовательности сообщений для всех участников.
