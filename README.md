...
279 166 RPS × 0,5 = 139 583 CPS

При производительности одного сервера 6 676 CPS [9]:

139 583 CPS ÷ 6 676 CPS ≈ 20,9 → 21 сервер

21 > 5, выбираем «худший» случай - 21. С учётом резервирования (N + 1) — 22 сервера.
...
| **L7** | 22 | CPU 16 Cores, NIC 100GbE | N + 1 |
